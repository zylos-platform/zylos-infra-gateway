...
public class GatewayTokenExchanger {
     ...
     */
    public Mono<String> exchange(Jwt subjectToken, String audience, String scope) {
        CacheKey key = new CacheKey(subjectToken.getSubject(), audience, scope);

        return Mono.fromCompletionStage(cache.get(
                key,
                (_, _) -> doExchange(subjectToken.getTokenValue(), audience, scope)
                        .toFuture()));
    }

    private Mono<String> doExchange(String subjectTokenValue, String audience, String scope) {
        MultiValueMap<String, String> form = new LinkedMultiValueMap<>();

        form.add("grant_type", GRANT_TYPE);
        form.add("client_id", props.clientId());
        form.add("client_secret", props.clientSecret());
        form.add("subject_token", subjectTokenValue);
    ...
    private record CacheKey(String subject, String audience, String scope) {
        private CacheKey {
